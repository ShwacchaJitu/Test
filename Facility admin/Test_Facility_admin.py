...
def test_Edit_facility(org_login, take_screenshot):
    ...
    time.sleep(2)
    driver.find_element(By.XPATH, "//ul[@class='dropdown-menu ng-untouched ng-pristine ng-valid']/li[2]").click()
    time.sleep(2)
    ...
    take_screenshot()
    time.sleep(4)
    driver.find_element(By.XPATH, "/html/body/app-root/div[3]/app-facility-admin-list/div/div[1]/div[1]/img").click()
    time.sleep(4)
